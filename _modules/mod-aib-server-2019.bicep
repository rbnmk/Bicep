  ...
  properties: {
    ...
    customize: [
      ...
      }
      {
        ...
        runElevated: true
        inline: [
          'choco install pwsh git az.powershell azure-cli bicep pester psscriptanalyzer azcopy10 dotnetcore dotnetcore-sdk dotnet4.7 azure-functions-core-tools-3 --yes --no-progress'
