...
resource roleassignment 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  name: guid(subscription().subscriptionId, resourceGroup().id, principalId, !empty(roleName) ? roleIds[roleName] : subscriptionResourceId('Microsoft.Authorization/roleDefinitions', roleDefinitionId))
  properties: {
    roleDefinitionId: !empty(roleName) ? roleIds[roleName] : subscriptionResourceId('Microsoft.Authorization/roleDefinitions', roleDefinitionId)
